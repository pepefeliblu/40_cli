...
bool Carta40::operator<( Carta40& siguiente)
{
	
	return (getValor() < siguiente.getValor());
}
//Compara los valores del palo y el valor para evaluar si dos cartas son iguales
...
//Cambia el estado de si fué la ultima en jugarse
void Carta40::setUltima(bool isUltima)
{
	ultima = isUltima;
}
//Devuelve el estado si fué la ultima en jugarse
bool Carta40::getUltima()
{
	return ultima;
}
//Devuelve un puntero al arreglo carta
char *Carta40::getCarta()
{
	return carta;
}
//Devuelve el valor de la carta
int Carta40::getValor() 
{
	return valor;
}
