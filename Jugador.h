...
public:
  // El constructor solo toma el nombre asignado al jugador
  Jugador(std::string);
  ...
  // Devuelve una carta basada en el índice del arreglo mano
  Carta40 &getMano(int);
  ...
  // Devuelve la cantidad de cartas que el jugador tiene en la mano
  int cantCarta();
};
#endif
