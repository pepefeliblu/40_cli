...
void Usuario::jugar(Carta40 &mano, std::vector<Carta40> &mesa,
                    std::string &comando) {
  ...
  if (comando == "caida") {
    ...
    // Si el comando no existe pide que lo vuelva a escribir y la función se
    // llama de manera recursiva
    std::cout << "El comando que escribiste '" << comando
              << "' no existe, por favor escribelo nuevamente" << std::endl;
    std::cin >> comando;
